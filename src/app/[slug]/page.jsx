...
export default async function DynamicUniversalPage({ params }) {
  ...
  return (
    ...
    >
      ...
      <link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@600;700;800;900&family=Montserrat:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet" />
      <style>{`
        .font-serif {
