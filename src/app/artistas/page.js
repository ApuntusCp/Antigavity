...
export default function ArtistasFeed() {
  ...
  return (
    <MaintenanceGuard
      routeKey="/artistas"
      defaultTitle="GALERÍA DE ARTISTAS EN CONSTRUCCIÓN"
      defaultSubtitle="Estamos preparando la vitrina cultural e interactiva de artistas y creadores independientes de GranColinos."
      defaultModuleName="Galería de Artistas"
    >
