        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {brandFeaturedArticles.map((article) => (
              <div key={article.id} className="bg-black/40 border border-[#E2E8F0]/30 hover:border-[#E2E8F0]/70 rounded-2xl p-6 backdrop-blur-xl shadow-xl transition-all duration-300 flex flex-col justify-between">
                <div>
                  <span className="text-[#E2E8F0] text-[10px] font-bold tracking-widest uppercase block mb-2">
                    {article.category}
                  </span>
                  <h3 className="font-serif text-lg font-bold text-white mb-3 hover:text-[#E2E8F0] transition-colors leading-snug">
                    {article.title}
                  </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredNews.map((item) => (
                <a
                  ...
                  className="group bg-black/40 border border-[#E2E8F0]/20 hover:border-[#E2E8F0]/60 rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between hover:scale-[1.02] shadow-lg"
                >
                  <div>
                    <div className="flex items-center justify-between text-[11px] font-mono text-gray-400 mb-3">
                      <span className="text-[#E2E8F0] font-bold uppercase tracking-wider flex items-center gap-1">
                        {item.sourceName}
                      </span>
                    ...
                    <p className="text-gray-300 text-xs font-light leading-relaxed mb-6 line-clamp-3">
                      {item.summary}
                    </p>
                  </div>

                  <div className="flex items-center justify-between text-xs font-bold text-[#E2E8F0] pt-4 border-t border-white/10 group-hover:underline">
