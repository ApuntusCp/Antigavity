...
function renderUnderConstruction() {
  ...
  app.innerHTML = `
    <div style="min-height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; background-color: var(--bg); text-align: center; padding: 2rem;">
      ...
      <a href="https://wa.me/REPLACE_WITH_YOUR_NUMBER" target="_blank" style="background-color: var(--success); color: white; padding: 1rem 2rem; border-radius: 50px; text-decoration: none; font-weight: bold; font-size: 1.1rem; display: inline-flex; align-items: center; gap: 0.5rem; transition: transform 0.2s ease;">
...
function renderApp() {
  ...
  app.innerHTML = `
    ...
    <a href="https://wa.me/REPLACE_WITH_YOUR_NUMBER?text=Hola%20Gran%20Colinos,%20necesito%20asistencia%20con%20la%20tienda." 
       target="_blank" 
